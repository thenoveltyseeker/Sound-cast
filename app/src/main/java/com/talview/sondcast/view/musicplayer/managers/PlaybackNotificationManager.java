package com.talview.sondcast.view.musicplayer.managers;
...
public class PlaybackNotificationManager extends BroadcastReceiver {
	...
	private String createChannel() {
		String channelId = "SoundCast";
		String channelName = "SoundCastChannel";
		NotificationChannel channel = new NotificationChannel(channelId,
				channelName, NotificationManager.IMPORTANCE_LOW);
		channel.setLightColor(ContextCompat.getColor(mMediaService.getApplicationContext(), R.color.bt_accent));
	...
	private PendingIntent showNowPlaying() {
		...
		nowPlaying.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
